...
/**
 * The ModExp class evaluates expressions using the modulo operator
...
public class ModExp implements Expression{
    ...
    /**
     * Constructor for modulo operation
    ...
    /**
     *  Method to evaluate left and right expressions using the modulo operator
